const animalData = {
    ocean: {
        dolphin: {
            name: "Camel",
            description: "Camels move by pacing, a gait where they move both legs on one side of the body forward at the same time, creating a distinctive rocking or swaying motion often called the ship of the desert. This pacing is a steady, slow, and long stride that helps them move across sandy terrain."
        }
    },
    sky: {
        eagle: {
