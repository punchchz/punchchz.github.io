const animalData = {
    ocean: {
        dolphin: {
            name: "canada goose",
            description: "Canada geese fly in a V-formation to conserve energy, improve communication, and coordinate their flock. Each bird flies slightly higher than the one in front to take advantage of the updraft, reducing wind resistance and allowing them to fly farther. The lead goose rotates with other geese to share the effort of breaking through the wind resistance."
        }
    },
    sky: {
        eagle: {
