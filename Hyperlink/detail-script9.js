const animalData = {
    ocean: {
        dolphin: {
            name: "Zebra",
            description: "When zebras move, their stripes create a motion dazzle effect, an optical illusion that confuses predators by making it difficult to single out an individual from the herd. This pattern can mask an individual's direction and speed, increasing its chances of survival."
        }
    },
    sky: {
        eagle: {
